...
void login(string id, string password) {
  ...
  */
  ...
  unordered_map<string, int>::iterator it = Accounts.find(id);
...
void merge(string id_1, string password_1, string id_2, string password_2) {
  ...
  */
  ...
  unordered_map<string, int>::iterator it1 = Accounts.find(id_1);
  unordered_map<string, int>::iterator it2 = Accounts.find(id_2);
...
void transfer(string id, int value) {
  ...
  */
  ...
  unordered_map<string, int>::iterator it1 = Accounts.find(id);
  ...
  if (current_account->balance < value) {
    ...
    unordered_map<string, int>::iterator it2 = Accounts.find(current_account->id);
